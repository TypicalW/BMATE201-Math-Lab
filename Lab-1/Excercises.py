#Excercise: Write python programs for the following:
#1. Using Regula Falsi Method find the real root of the equaition:
#(a) xe^(x) =2 

import sys 
import math
f= lambda x: x*((math.e)**x)-2                   #Question-Equation
